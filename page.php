            ...
            <div class="row layout-top-spacing">
                    ...
                    <div class="widget widget-chart-one">
                        <div class="widget-heading">
                            ...
                            <ul class="tabs tab-pills">
                                <li><a href="javascript:void(0);" id="tb_1" class="tabmenu">Administration</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="widget-two">
                        <div class="widget-content">
                            <div class="w-numeric-value">
                                <div class="w-content">
                                    <span class="w-value">Revenu générale</span>
                                    <span class="w-numeric-title">1000</span>
                                </div>
                                <div class="w-icon">
                        ...
                        <div class="widget-content">
                            <div class="invoice-box">
                                ...
                                <div class="inv-action">
                                    <a href="" class="btn btn-dark">Résumé</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-table-three">
                        ...
                        <div class="widget-heading">
                            <h5 class="">Meilleurs produits</h5>
                        </div>
